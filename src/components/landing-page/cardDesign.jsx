      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 items-center gap-x-16 gap-y-16 lg:grid-cols-2">
          ...
          <div className="relative h-96">
            {/* Gambar kartu-kartu yang bertumpuk */}
            <Image
              src="/creditcard.png"
              alt="Card 1"
              width={400}
            ...
            <Image
              ...
              width={400}
              height={250}
              className="absolute top-10 right-10 transform rotate-[-3deg] transition-transform duration-500 hover:rotate-0"
            />
            <Image
              src="/creditcard.png"
              alt="Card 3"
              width={400}
              height={250}
              className="absolute top-20 right-20 transform rotate-2 transition-transform duration-500 hover:rotate-0"
            />
          </div>
        </div>
      </div>
